...
exports.deleteInvoice = exports.updateInvoiceStatus = exports.getInvoice = exports.createAutopilotInvoice = exports.createInvoice = exports.listInvoices = void 0;
...
const createAutopilotInvoice = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const projectId = typeof ((_b = req.body) === null || _b === void 0 ? void 0 : _b.project_id) === 'string' && req.body.project_id.trim()
            ? req.body.project_id.trim()
            : null;
        const clientName = typeof ((_c = req.body) === null || _c === void 0 ? void 0 : _c.client_name) === 'string' && req.body.client_name.trim()
            ? req.body.client_name.trim()
            : null;
        const taxRateValue = parseTaxRate((_d = req.body) === null || _d === void 0 ? void 0 : _d.tax_rate);
        const where = {
            status: 'approved',
            is_billable: true,
        ...
        if (entries.length === 0) {
            (0, http_1.sendApiError)(res, 400, 'VALIDATION_ERROR', 'No approved billable entries are available for autopilot invoicing');
            return;
        }
        const resolvedProjectId = projectId || ((_e = entries[0].project) === null || _e === void 0 ? void 0 : _e.id) || null;
        const resolvedClientName = clientName || ((_f = entries[0].project) === null || _f === void 0 ? void 0 : _f.name) || 'Web Forx Client';
        ...
        (0, http_1.sendApiError)(res, 500, 'INVOICE_AUTOPILOT_FAILED', 'Internal server error');
    }
});
exports.createAutopilotInvoice = createAutopilotInvoice;
